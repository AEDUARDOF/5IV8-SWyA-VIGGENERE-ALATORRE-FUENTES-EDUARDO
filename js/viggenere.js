...
key = document.getElementById('LlavePassword').value;

key = key.replace(/ /g,'');

//mensaje

let mess = document.getElementById('TextoInput').value;
...
document.getElementById('ver').value = newMess;
}else{
...
mess = document.getElementById('TextoInput').value;
